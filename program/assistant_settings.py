...
async def leave_chat(c :Client, m: Message):
    ...
    try:
        if chat_id in QUEUE:
            ...
            return await c.send_message(chat_id, "😇ᴀssɪsᴛᴀɴᴛ ʟᴇᴀᴠᴇ ғʀᴏᴍ ᴄʜᴀᴛ")
        else:
            await user.leave_chat(chat_id)
            return await c.send_message(chat_id, "🙏 ᴀssɪsᴛᴀɴᴛ ʟᴇᴀᴠᴇ ғʀᴏᴍ ᴄʜᴀᴛ")
    except UserNotParticipant:
        return await c.send_message(chat_id, "❌ ᴀssɪsᴛᴀɴᴛ ᴀʟʀᴇᴀᴅʏ ʟᴇᴀᴠᴇᴅ")
...
async def leave_all(c: Client, message: Message):
    ...
    run_1 = 0
    run_2 = 0
    msg = await message.reply("🔄 ᴀssɪsᴛᴀɴᴛ ʟᴇᴀᴠɪɴɢ ғʀᴏᴍ ᴀʟʟ ᴄʜᴀᴛ!!")
    async for dialog in user.iter_dialogs():
        try:
            ...
            run_1 += 1
            await msg.edit(
                f"ᴀssɪsᴛᴀɴᴛ ʟᴇᴀᴠɪɴɢ...\n\nʟᴇғᴛ ғʀᴏᴍ: {run_1} ᴄʜᴀᴛs.\nғᴀɪʟᴇᴅ ɪɴ: {run_2} ᴄʜᴀᴛs."
            )
        except Exception:
            run_2 += 1
            await msg.edit(
    ...
    await client.send_message(
        message.chat.id, f"✅ ʟᴇғᴛᴇᴅ ғʀᴏᴍ: {run_2} ᴄʜᴀᴛs.\n❌ ғᴀɪʟᴇᴅ ɪɴ: {run_2} ᴄʜᴀᴛs."
    )
...
async def start_group_call(c: Client, m: Message):
    ...
    try:
        ...
        await msg.edit_text(
            "ᴀssɪsᴛᴀɴᴛ ɪs ɴᴏᴛ ᴀᴅᴍɪɴ ɪɴ ᴛʜɪs ᴄʜᴀᴛ ♥️\n\n ᴘʟᴇᴀsᴇ ᴍᴀᴋᴇ ᴀᴅᴍɪɴ ᴡɪᴛʜ ᴠᴄ ʀɪɢʜᴛ ғɪʀsᴛ🐬"
        )
...
async def stop_group_call(c: Client, m: Message):
    ...
    try:
        if not (
            ...
            await msg.edit_text("❌ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴀʟʀᴇᴀᴅʏ ᴇɴᴅᴇᴅ")
            return
        await user.send(
            DiscardGroupCall(
                call=group_call
        ...
        await msg.edit_text("✅ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴇɴᴅᴇᴅ !")
